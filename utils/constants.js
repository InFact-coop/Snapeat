...
// Consent Actions
export const NO_CONSENT_FOR_USAGE = 'NO_CONSENT_FOR_USAGE'
export const USER_CONSENT_FOR_USAGE = 'USER_CONSENT_FOR_USAGE'
...
export const FISH = 'fish/seafood'
...
export const FIZZY_DRINK = 'fizzy-drink'
